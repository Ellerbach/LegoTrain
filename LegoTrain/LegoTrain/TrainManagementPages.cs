...
namespace LegoTrain
{
    partial class TrainManagement
    {
        ...
        private GetResponse ProcessDisplayCircuit(string rawURL)
        {
            ...
            strResp += "if (boxMSG.src.indexOf('green.png')>=0) mycmd+='0'; else mycmd += '1';";
            ...
            strResp += "var NumberSignal=" + mySignal.NumberOfSignals + ";";
        ...
        private GetResponse ProcessDisplayDefault(string rawUrl)
        {
            ...
            for (byte i = 0; i < myParamRail.NumberOfSignals; i++)
            {
                strResp += "<TR><FORM><TD>Signal " + myParamRail.Signals[i].Name + "</TD><TD><INPUT type=\"button\" onClick=\"btnclicked(document.getElementById('signal" + i + "'),'" + pageSignal + "?si=" + i + "&md=0&no=1')\" value=\"Red\"></TD>";
                strResp += "<TD><INPUT type=\"button\" onClick=\"btnclicked(document.getElementById('signal" + i + "'),'" + pageSignal + "?si=" + i + "&md=1&no=1')\" value=\"Green\"></TD>";
